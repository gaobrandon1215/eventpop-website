...
const CATALOG = [
  ...
  // ── INFLATABLES (6) ──
  {id:64,cat:'inflatables',catLabel:'🏰 Inflatables', name:'Classic Bounce House', priceLow:130,priceHigh:170,emoji:'🏰', desc:'Classic bounce house fun for birthdays and outdoor parties.', img:'https://source.unsplash.com/500x300/?bounce,house,kids'},
  {id:65,cat:'inflatables',catLabel:'🏰 Inflatables', name:'Combo Bounce House + Slide', priceLow:175,priceHigh:225,emoji:'🏰', desc:'Bounce AND slide combo — best value for kids parties.', img:'https://source.unsplash.com/500x300/?inflatable,slide,fun'},
  ...
  {id:67,cat:'inflatables',catLabel:'🏰 Inflatables', name:'Water Slide Inflatable', priceLow:200,priceHigh:260,emoji:'💦', desc:'Summer hit — water slide inflatable for backyard parties.', img:'https://source.unsplash.com/500x300/?water,slide,summer'},
  ...
  // ── NERF WARS (4) ──
  {id:70,cat:'nerf',catLabel:'🔫 Nerf Wars', name:'Hosted Nerf Party (up to 10 kids)', priceLow:199,priceHigh:199,emoji:'🔫', desc:'Fully hosted Nerf battle — our signature experience. Staff included.', img:'https://source.unsplash.com/500x300/?nerf,battle,kids'},
  {id:71,cat:'nerf',catLabel:'🔫 Nerf Wars', name:'Hosted Nerf Party (up to 20 kids)', priceLow:299,priceHigh:299,emoji:'🔫', desc:'Large hosted Nerf battle for bigger birthday groups. Fully staffed.', img:'https://source.unsplash.com/500x300/?nerf,party,outdoor'},
  {id:72,cat:'nerf',catLabel:'🔫 Nerf Wars', name:'Nerf Equipment Only (no host)', priceLow:75,priceHigh:75,emoji:'🔫', desc:'Rent the blasters, ammo, vests, and barriers — no host included.', img:'https://source.unsplash.com/500x300/?nerf,blaster,toy'},
  ...
  // ── PHOTO (6) ──
  {id:74,cat:'photo',catLabel:'📸 Photo & Video', name:'Photo Booth (2-hour)', priceLow:250,priceHigh:320,emoji:'📸', desc:'2-hour open-air photo booth with props and instant prints.', img:'https://source.unsplash.com/500x300/?photo,booth,event'},
  {id:75,cat:'photo',catLabel:'📸 Photo & Video', name:'Photo Booth (4-hour)', priceLow:375,priceHigh:475,emoji:'📸', desc:'4-hour open-air photo booth — most popular option for parties.', img:'https://source.unsplash.com/500x300/?photobooth,props,fun'},
  ...
  {id:77,cat:'photo',catLabel:'📸 Photo & Video', name:'Selfie Mirror Booth', priceLow:325,priceHigh:415,emoji:'🪞', desc:'Full-length mirror booth with touchscreen and instant prints.', img:'https://source.unsplash.com/500x300/?mirror,booth,selfie'},
